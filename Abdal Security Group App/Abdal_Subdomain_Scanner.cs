...
namespace Abdal_Security_Group_App
{
    public partial class Abdal_Admin_Finder : Telerik.WinControls.UI.RadForm
    {
        ...
        public Abdal_Admin_Finder()
        {
            ...
            Text = "Abdal Subdomain Scanner" + " " + version.Major + "." + version.Minor; //change form title
        ...
        private void bgWorker_req_maker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            crawled_links_text.Text = 0.ToString();
            lb_total_request.Text = 0.ToString();
            Int32 total_request_counter = 0;
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        radProgressBar1.Maximum = SubdomainAddress.admin_address.Count();
                        ...
                        for (int i = 1; i <= 1; i++)
                        {
                            ...
                            {
                                foreach (string admin_address_pages in SubdomainAddress.admin_address)
                                {
                                    ...
                                    if (agent_ToggleSwitch.Value)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                http.UserAgent =
                                                    "Mozilla/5.0 (BlackWin 4.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.246";
                                            }
                                            ...
                                            else if (rand_agent_List[index_rand_agent] ==
                                    ...
                                    if (admin_address_pages != "")
                                    {
                                        ...
                                        Chilkat.Task task =
                                            http.QuickGetObjAsync( radDropDownList_protocol.Text + admin_address_pages + "." + targetUrl  );
                                         
                                        if (http.LastMethodSuccess == true)
                                        {
                                            total_request_counter += 1;
                                            lb_total_request.Text = total_request_counter.ToString();
                                            ResultTextEditor.AppendText(radDropDownList_protocol.Text + admin_address_pages + "." + targetUrl +
                                        ...
                                        if (task.StatusInt != 7)
                                        {
                                            ...
                                            ResultTextEditor.AppendText("task status: " + task.Status +
                                                                        Environment.NewLine);
                                            ResultTextEditor.SelectionStart = ResultTextEditor.Text.Length;
                                            ResultTextEditor.ScrollToCaret();
                                        }
                                        ...
                                        if (resp.StatusCode.ToString() == "200" && resp.StatusCode.ToString() != "301" && resp.StatusCode.ToString() != "302")
                                        {
                                            ...
                                            ExtractRichTextBox.AppendText("[+] " + radDropDownList_protocol.Text + admin_address_pages + "." + targetUrl + Environment.NewLine);
                                            ...
                                            {
                                                MessageBox.Show(
                                                    "Please Use The Abdal Google Dork, Because This Site Gives The Wrong Answer");
                                                break;
                                            }
                                        }
                                        /////////////////////////////////////////////////////////////////////////////////////
...
//            radRadialGauge1.Value = e.ProgressPercentage;
        ...
        private void Abdal_Admin_Finder_FormClosing(object sender, FormClosingEventArgs e)
        {
